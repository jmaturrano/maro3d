...
function dvin_wcql_grand_total_row($arr_cols,$cols_counter,$grand_total_qty,$grand_total_price,$data_arr) {
      ...
      //grand total price
        if($grand_total_price>=0 && isset($arr_cols['subtotal'])) {
            ?>
            <tr>
                <td colspan="<?php echo $cols_counter-2;?>" align="right">
                ...
                <td align="right" style="<?php echo apply_filters('dvin_wcql_grandtotalpricecell_style','');?>" class="grandtotalpricecell" class="grandtotalpricecell"><?php echo wc_price($grand_total_price); ?></td>
            </tr>
            <?php
            }//end of grand total
}
