      ...
      <div class="container">
        <div class="row">
          <div class="section-top wow animated fadeInUp" data-wow-delay=".5s">
            <?php if ( get_theme_mod('section_title', '') != '' ){ ?>
              <h2 class="section-title">
                <?php echo  get_theme_mod('section_title', ''); ?>
              </h2>
            <?php } ?>
            <?php if ( get_theme_mod('section_description', '') != '' ){ ?>
              <p class="section-description">
                <?php echo  get_theme_mod('section_description', ''); ?>
                ...
                if( get_theme_mod('page-column'.$is,false) ) {
                  ...
                  while( $queryvar->have_posts() ) : $queryvar->the_post(); ?> 
                    ...
                    <div class="col-md-3 col-sm-6">
                      <div class="box-service item wow animated fadeInRight" data-wow-delay=".35s">
                          <div class="item-icon">
                          ...
                          <div class="item-details">
                            ...
                            <!--<p class="item-description"><?php /*the_excerpt();*/ ?><!--</p>--><!-- /.item-description -->
                            <span class="item-description"><?php the_content(); ?></span><!-- /.item-description -->
                          </div><!-- /.item-details -->
                      </div><!-- /.item -->
                    </div>
