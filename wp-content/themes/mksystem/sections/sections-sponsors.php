<?php
$jeweltheme_polmo_sponsors_title = get_theme_mod('jeweltheme_polmo_sponsors_title',__('<span>Nuestros</span> Trabajos','polmo-lite'));
...
<script>
  jQuery(document).ready(function(){
    jQuery('.sponsors-logo').find('a').attr('href', 'javascript:;');
  });
</script>